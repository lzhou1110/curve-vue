...
let routes = [
  ...
  {
    path: '/:pool(compound|usdt|y|iearn|busd|susdv2|pax|tbtc|ren|sbtc|hbtc|pool3)/',
    name: 'Index',
    component: PoolApp,
    children: [
      {
...
const pools = ['compound','usdt','y','iearn','busd','susd', 'susdv2','pax','tbtc','ren', 'sbtc', 'hbtc', 'pool3']
